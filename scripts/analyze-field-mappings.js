...
console.log(
  "- Owner email: Properly handles null (data.company?.properties?.email___owner || null)"
)
console.log(
  "- Dwolla ID: Properly handles null (data.company?.properties?.dwolla_customer_id || null)"
)
