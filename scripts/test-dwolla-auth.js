...
async function testDwollaAuth() {
  ...
  const authUrl =
    DWOLLA_ENVIRONMENT === "production" ? "accounts.dwolla.com" : "accounts-sandbox.dwolla.com"
...
async function testApiCall(accessToken) {
  ...
  const apiUrl = DWOLLA_ENVIRONMENT === "production" ? "api.dwolla.com" : "api-sandbox.dwolla.com"
