...
export function ListTrendChart({ listName, data, timeframe }: ListTrendChartProps) {
  ...
  if (!data || data.length === 0) {
    return (
      <Card className="border-cakewalk-border shadow-cakewalk-light">
      ...
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center gap-2">
            <span className="font-cakewalk-medium text-cakewalk-body-sm text-cakewalk-text-primary">
        ...
        <div className="h-48 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={chartData} margin={{ top: 5, right: 5, left: 5, bottom: 5 }}>
              ...
              />
              <YAxis tick={{ fontSize: 12, fill: "#5d6b85" }} axisLine={{ stroke: "#cbdeff" }} />
              <Tooltip
                contentStyle={{
                  backgroundColor: "#fff",
