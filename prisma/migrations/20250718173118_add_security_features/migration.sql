-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('USER', 'ADMIN', 'SUPPORT', 'TECHNICAL_SUPPORT');

-- CreateEnum
CREATE TYPE "SearchType" AS ENUM ('EMAIL', 'NAME', 'BUSINESS_NAME', 'DWOLLA_ID', 'COMBINED');
...
-- CreateIndex
CREATE INDEX "MFARecovery_userId_idx" ON "MFARecovery"("userId");
