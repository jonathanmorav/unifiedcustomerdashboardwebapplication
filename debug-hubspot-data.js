          ...
          if (response.results && response.results.length > 0) {
            ...
            response.results.forEach((company, index) => {
              ...
              console.log(
                ...
                JSON.stringify(company.properties, null, 4)
              )
              ...
              console.log(
                "   - onboarding_status type:",
                typeof company.properties?.onboarding_status
              )
            ...
            console.log(
              "   - data.company?.properties?.onboarding_status:",
              company.properties?.onboarding_status
            )
            console.log(
              "   - data.company?.properties?.onboarding_step:",
              company.properties?.onboarding_step
            )
            console.log(
              "   - onboardingStatus result:",
              company.properties?.onboarding_status || null
            )
            ...
            console.log(
              ...
              JSON.stringify(mockFormattedData.company, null, 2)
            )
          } else {
